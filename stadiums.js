        ...
        styles: [
            {
                ...
                physics: { 
                    friction: 0.99, 
                    radiusMod: 0.9,
                    basinSpinSpeed: 0.15, // Positive = Clockwise, Negative = Counter-Clockwise
                    basinGrip: 0.255,        // How strongly the spinning floor pushes the Beyblade
            ...
            },
			{
                ...
                physics: { 
                    friction: 0.99, 
                    radiusMod: 0.9,
                    basinSpinSpeed: 0.3, // Positive = Clockwise, Negative = Counter-Clockwise
                    basinGrip: 0.4,        // How strongly the spinning floor pushes the Beyblade
					basinRadius: 0.3 // DEFAULT IS 0.3 (30%). Tweak this if your basin is wider!
                },
                ringOutZones: [
